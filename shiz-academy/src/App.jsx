...
export default function App() {
  ...
  const [midnightHazeAllGenres, setMidnightHazeAllGenres] = useState(false);
  ...
  const [rainfallAllGenres, setRainfallAllGenres] = useState(false);
  ...
  const [spotlightAllGenres, setSpotlightAllGenres] = useState(false);
  ...
  const [rivetFilterAllGenres, setRivetFilterAllGenres] = useState(false);
...
// --- Persistence (localStorage) ---
  ...
  function applySaveSnapshot(s) {
    try {
      ...
      if (typeof s.midnightHazeAllGenres === 'boolean') setMidnightHazeAllGenres(s.midnightHazeAllGenres);
      ...
      if (typeof s.rainfallAllGenres === 'boolean') setRainfallAllGenres(s.rainfallAllGenres);
      ...
      if (typeof s.spotlightAllGenres === 'boolean') setSpotlightAllGenres(s.spotlightAllGenres);
      ...
      if (typeof s.rivetFilterAllGenres === 'boolean') setRivetFilterAllGenres(s.rivetFilterAllGenres);
  ...
  useEffect(() => {
    const shouldFlash = !!(isPerforming && performingSong && ((performingSong.genre === 'Rock') || rainfallAllGenres) && rainfallUnlocked);
    if (!shouldFlash) {
  ...
  }, [isPerforming, performingSong, rainfallUnlocked, rainfallAllGenres]);

  // Trigger Spotlight Snap at start of Hip-Hop performance (or any if All Genres)
  useEffect(() => {
    const shouldSnap = !!(isPerforming && performingSong && (((performingSong.genre === 'Hip-Hop') || spotlightAllGenres)) && spotlightSnapUnlocked);
    if (!shouldSnap) {
  ...
  }, [isPerforming, performingSong, spotlightSnapUnlocked, spotlightAllGenres]);

  // Generate DOM bubble seeds when Pink Bubbles is active (Pop or All Genres)
  useEffect(() => {
    const active = !!(isPerforming && performingSong && (((performingSong.genre === 'Pop') || pinkBubblesAllGenres)) && pinkBubblesUnlocked && pinkBubblesEnabled);
        ...
        <div style={styles.grid}>
          ...
          <section style={styles.section}>
            ...
            <div style={styles.roomOuter}>
              ...
              {/* Performance cosmetic overlay: Midnight Haze (Synthwave or All Genres) */}
              {isPerforming && performingSong && ((performingSong.genre === 'Synthwave') || midnightHazeAllGenres) && midnightHazeUnlocked && midnightHazeEnabled && (
                <div style={styles.performHazeOverlay}>
                  <div style={styles.performHazeShimmer} />
                </div>
              )}

              {/* Performance cosmetic overlay: Rainfall Lighting (Rock or All Genres) */}
              {isPerforming && performingSong && ((performingSong.genre === 'Rock') || rainfallAllGenres) && rainfallUnlocked && rainfallEnabled && (
              ...
              {/* Performance cosmetic overlay: Iron Overture Filter (Metal or All Genres) */}
              {isPerforming && performingSong && ((performingSong.genre === 'Metal') || rivetFilterAllGenres) && rivetFilterUnlocked && rivetFilterEnabled && (
