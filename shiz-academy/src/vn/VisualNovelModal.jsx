...
export default function VisualNovelModal({
  ...
  const FRIEND_META = {
    ...
    aureliagleam: { name: 'Aurelle Starlight', bust: '/art/friends/aurellestarlight_bust.png' },
  ...
  }, [open, friendModal.friendId, friendModal.targetLevel, friendModal.idx, lines, rivetFilterUnlocked, setRivetFilterUnlocked, pushToast]);
